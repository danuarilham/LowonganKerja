                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($info_pekerjaan as $row) { ?>
                                        <tr>
                                            <!-- <th scope="row"><?= $i ?></th> -->
                                            <td><img src="../assets/img/logo/<?= $info['logo_perusahaan'] ?>" alt="" width="60px" class="rounded-circle"></td>
                                            <td><?= $row['judul'] ?> <br> <span style="color: gray;" class="font-weight-light">Jawa Barat</span> </td>
