...
FROM
	...
	lokasi_pekerjaan
	ON 
		info_pekerjaan.id_lokasi = lokasi_pekerjaan.id_lokasi ORDER BY id_pekerjaan DESC LIMIT $awalData, $jumlahDataPerHalaman");
                        ...
                        <div class="single-job-items mb-30">
                            <div class="job-items">
                                <div class="company-img">
                                    <a href="job_details.php?id=<?= $row['id_pekerjaan'] ?>"><img src="assets/img/logo/<?= $row['logo_perusahaan'] ?>" alt="" width="100px"></a>
                                </div>
